          ...
          <Sider trigger={null} collapsible collapsed={collapsed} width={256}>
            ...
            <div>
              <Menu theme="dark" defaultSelectedKeys={['1']} mode="inline">
                ...
                >
                  <Menu.Item key="2">
                    <Link to="/home/motto">Motto</Link>
                  </Menu.Item>
                  <Menu.Item key="3">
                    <Link to="/home/announcement">Announcement</Link>
                  </Menu.Item>
                  <Menu.Item key="4">
                    <Link to="/home/project">Project</Link>
                  </Menu.Item>
                  <Menu.Item key="5">
                    <Link to="/home/cover">Cover</Link>
                  </Menu.Item>
                </SubMenu>
                <SubMenu
                  key="sub2"
                ...
                >
                  <Menu.Item key="6">
                    <Link to="/music/liveTour">Live Tours</Link>
                  </Menu.Item>
                  <Menu.Item key="7">
                    <Link to="/music/featuredRecord">Featured Records</Link>
                  </Menu.Item>
                  <Menu.Item key="8">
                    <Link to="/music/yanceyMusic">Yancey Music</Link>
                  </Menu.Item>
                  <Menu.Item key="10">
          ...
          <Layout>
            ...
            <Content>
              <Switch>
                ...
                <Route
                  path="/music/featuredRecord"
                  component={FeaturedRecord}
                />
